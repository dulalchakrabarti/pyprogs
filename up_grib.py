...
Replicating the same formula as mentioned in Wiki
    ...
    return km
#URL=
#"https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?file=gfs.t00z.pgrb2.0p25.f000&lev_10_m_above_ground=on&lev_surface=on&var_APCP=on&var_GUST=on&var_TMP=on&var_UGRD=on&var_VGRD=on&var_VIS=on&subregion=&leftlon=77&rightlon=84&toplat=32&bottomlat=25&dir=%2Fgfs.20220701%2F00%2Fatmos"
import pandas as pd
import xarray as xr
import numpy as np
...
#print(lalo)
#print(stn)
ds = xr.open_dataset('up.grb', engine='cfgrib')
print(ds)
lat = ds.t2m.latitude.data
lon = ds.t2m.longitude.data
