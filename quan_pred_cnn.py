...
for data_dir in [os.path.join("..", "Examples", "Image", "DataSets", "MNIST"),
    ...
    train_file=os.path.join(data_dir, "jan15to31.txt")
    test_file=os.path.join(data_dir, "sat_cntk.txt")
...
img_data = np.reshape(img_data, (eval_minibatch_size, 4, 15, 15))
