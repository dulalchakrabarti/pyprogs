...
import numpy as np
u850 = []
url = 'http://nomads.ncep.noaa.gov:80/dods/gfs_0p25_1hr/gfs20220509/gfs_0p25_1hr_06z.ascii?ugrdprs[0][5][360:520][240:480]'
...
v850 = []
url = 'http://nomads.ncep.noaa.gov:80/dods/gfs_0p25_1hr/gfs20220509/gfs_0p25_1hr_06z.ascii?vgrdprs[0][5][360:520][240:480]'
html = requests.get(url).text
vals = html.split('\n')
for item in vals:
 item = item.split(',')
