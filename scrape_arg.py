...
fl = open('arg.csv','w')
gl.write('LAT'+','+'LON'+','+'SN'+','+'DT'+','+'ST'+','+'DA'+','+'TM'+','+'TP'+','+'TN'+','+'TX'+','+'TD'+','+'RH'+','+'R1'+','+'R2'+','+'BT'+','+'GP'+'\n')
for item in st_lst:
 html = urllib2.urlopen("http://210.212.167.219/AWS/data1.php?a=arg&b="+item+"&c=ALL_DISTRICT&d=ALL_STATION&e="+date+"&f="+date+"&g="+time+"&h=0").read()
 #print 'State: '+item
