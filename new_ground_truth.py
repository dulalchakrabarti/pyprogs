...
rep = '' 
for item in coun:
 f1 = urllib.request.urlopen("https://www.ogimet.com/display_synopsc2.php?lang=en&estado="+item+"&tipo=ALL&ord=REV&nil=NO&fmt=txt&ano=2022&mes=02&day=05&hora=00&anof=2022&mesf=02&dayf=05&horaf=00&send=send")
 txt1 = f1.read()
 syn = txt1.split(b'\n')
 for item in syn:
  #print(item)
